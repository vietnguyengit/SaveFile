...
public class DialogNewLocation extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final EditText editCity = dialogView.findViewById(R.id.edit_city);
        final EditText editLat = dialogView.findViewById(R.id.edit_lat);
        final EditText editLong = dialogView.findViewById(R.id.edit_long);
        final EditText editTimezone = dialogView.findViewById(R.id.edit_timezone);
